                ...
                <Carousel>
                    <Carousel.Item>
                        ...
                        <Carousel.Caption className='caption-crsal'>
                            <h2 style={{ fontSize: "40", color: "black" }}><b style={{ color: "red" }} >Web</b> development Company</h2>
                            <p style={{ fontSize: "40", color: "black" }} ><b style={{ color: "red" }}>#1</b> Ranked as #1 top Web development Company</p>
                        </Carousel.Caption>
                    </Carousel.Item>
