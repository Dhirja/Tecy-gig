    ...
    <div className="footer-container-main">
      <div className="footer-container">
        <div>
          ...
          <p>
            Tecygig (Technology Vechile) is one of the leading company with full
            of young energy which was founded in 2020. We take the honour to
            introduce ourself as one of the fastest growing company.
          </p>
          <button
            className="buttn-icon"
            onClick={() => {
        ...
        <div>
          ...
          <p>
            ...
            Santacruz East, Mumbai, Maharashtra 400029
          </p>
        </div>
        <div>
          <h3>Contact</h3>
          <hr />
          <p>
            Let's go! Please fill out your details below and we will get back to
            you within 24 hours.
          </p>
          <ul
            className="no-bullet"
            style={{ fontSize: "18px", marginLeft: "-19px" }}
          >
            <li>
              <Link
                to={`tel:${phoneNumber}`}
                style={{ textDecoration: "none", color: "rgb(173, 168, 168)" }}
                onClick={handleClick}
              >
                <FcCallback /> : {phoneNumber}
              </Link>
            </li>
            <li>
              {" "}
              <AiOutlineMail /> : tecygig@gmail.com
            </li>
            <li>
              <AiOutlineMail /> : info@tecygig.com
            </li>
            <li>
              <FcRefresh /> : 5 ,3A-Bwing Shradda
            </li>
          </ul>
          <p>
            Darshan Yeshwant Nagar Opp Shiv Sena Office Vakola Santacruz East
            400055 Mumbai
          </p>
        </div>
      </div>
