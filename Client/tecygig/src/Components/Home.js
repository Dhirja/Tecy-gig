...
import { FcBiotech, FcFrame, FcWorkflow, FcMultipleDevices, FcRating, 
        FcShipped, FcVoicePresentation,FcPlus,FcGraduationCap,FcInTransit,
        FcGlobe,FcDepartment,FcCloseUpMode,FcEmptyFilter,FcInspection,FcOrgUnit } from "react-icons/fc";
        ...
        return (
            <div className='home-container'>
                    ...
                    <Row className='border'>
                        <Col sm={6}>
                            ...
                            <p className='p-info'>
                                ...
                                IT Software Solutions provider based in Mumbai,India, established
                                in 2020.<br /><br />
                                ...
                                <br /><br />
                                We have dedicated and skilled human mind which will be doing Web development for you. Our aim is to give you, as customers, continuous support in developing and maintaining dedicated website carefully craft for your business enhancement
                            </p>
                        ...
                        <Col sm={6}>
                            <Row className='border'>
                                ...
                                <Col sm={4} className='border year-info'>
                                    <img className='p-3' src='https://www.hyperlinkinfosystem.com/assets/frontend_assets/img/about/dating-app.png' />
                                    <h2 className='fs-1 mt-2 '>90+</h2>
                                    <p style={{ fontSize: "19px" }}>Mobile Apps Developed</p>
                                </Col>
                                <Col sm={3} className='border year-info'>
                                    <img className='p-3' src='https://www.hyperlinkinfosystem.com/assets/frontend_assets/img/about/data.png' />
                                    <h2 className='fs-1 mt-2 '>150+</h2>
                                    <p style={{ fontSize: "19px" }}>Websites Developed</p>
                                </Col>
                                <Col sm={4} className='border year-info'>
                                    <img className='p-3' src='https://www.hyperlinkinfosystem.com/assets/frontend_assets/img/about/customer-review.png' />
                                    <h2 className='fs-1 mt-2 '>4.9</h2>
                                    <p style={{ fontSize: "19px" }}>Rating</p>
                                </Col>
                                <Col sm={4} className='border year-info'>
                                    <img className='p-3' src='https://www.hyperlinkinfosystem.com/assets/frontend_assets/img/about/app-development-ab.png' />
                                    <h2 className='fs-1 mt-2 '>110</h2>
                                    <p style={{ fontSize: "19px" }}>App Downloads on App Stores (iOS + Android)</p>
                                </Col>
                                <Col sm={3} className='border year-info'>
                                    <img className='p-3' src='https://www.hyperlinkinfosystem.com/assets/frontend_assets/img/about/web-development.png' />
                                    <h2 className='fs-1 mt-2 '>100+</h2>
                                    <p style={{ fontSize: "19px" }}>Dedicated Developers & Designers</p>
                                </Col>
                            </Row>
                        </Col>
                    </Row>
                        ...
                        <Row className=' p-1'>
                            <Col sm={5} className='col-work'>
                                ...
                                <p style={{ textAlign: 'justify' }}>
                                    Tecygig provides domains such as Software Development, Mobile Application Development ,IOS Development, Website Development, E- Commerce and Digital Marketing.We as a team are highly motivated to provide best service to our customers at the earliest. We are very flexible with our resources as per our client needs
                                </p>
                            </Col>
                            <Col sm={6} >
                ...
                <div className='container-social-media'>
                    ...
                    <div >
                        <Button variant="outline-dark" className='btun-social-icon' onClick={() => { window.location.href = 'https://www.facebook.com/Tecygig/'; }} >
                            <img src='https://www.hyperlinkinfosystem.com/assets/frontend_assets/img/fb-icon.svg' />
                        </Button>
                        <Button variant="outline-dark" className='btun-social-icon' onClick={() => { window.location.href = 'https://twitter.com/home'; }}>
                        ...
                        <Button variant="outline-dark" className='btun-social-icon' onClick={() => { window.location.href = 'https://www.linkedin.com/company/tecygig/'; }}>
                            <img src='https://www.hyperlinkinfosystem.com/assets/frontend_assets/img/in-icon.svg' />
                        </Button>
                        <Button variant="outline-dark" className='btun-social-icon' onClick={() => { window.location.href = 'https://in.pinterest.com/tecygig/_saved/'; }}>
