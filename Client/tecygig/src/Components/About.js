    ...
    return (
      <div className="about-main-container">
        <Container>
          <Row className="border about-row">
            ...
            <Col sm={6}>
              ...
              <p className="aim-ptag">
                Our Only Aim,{" "}
                <span style={{ color: "green" }}>Happy Clients.</span>
              </p>
            </Col>
            <Col sm={6}>
              <h2 className="mt-3 p-2">
                We Provide Quality Business & Smart Solution
              </h2>
              <p className=" p-2 mt-3 ptag">
                Tecygig (Technology Vechile) is one of the leading company with
                full of young energy which was founded in 2020. We take the
                honour to introduce ourself as one of the fastest growing
                company.
              </p>
            </Col>
            <Col sm={6}>
              <img
                className="img-tecy"
                src="https://www.tecygig.com/img/about.jpg"
              />
            </Col>
          </Row>
        </Container>
        ...
        <Container className="ptag-container">
          <p>
            We have a good and proper coordinating partnership between the
            company's intramural internal environments and emerging external IT
            surrounding. The enhanced brand equity and sales shall actually
            determine the promising results of this IT service provider. The
            success of the company is measured in such a way on how the people
            share, enjoy as well as obtain advantages from the efficacy. Some of
            our company values are hard work, growth, integrity, enthusiasm, and
            helping each other.
            <br />
            <br />
            The management believes that infinite opportunities are provided by
            the growth of the company as well as the individuals. The success
            shall be celebrated by comprehending the alterations towards growth.
            The value we create will normally be consistent with that of the
            company's mission and we make use of both amazing effort and
            intelligence in order to safeguard the created values. Hyperlink
            will never mind about the consequences and will carry out the things
            if it feels to be correct accordingly. The employees of the company
            are passionate towards the work and will put the efforts to reach
            success as well as to achieve the objectives irrespective of the
            surroundings and situations. We are more helpful in the success of
            each other and are careful in establishing a long-term partnership
        ...
        <Container>
          <Row className="year-container">
            <Col sm={6} className="border">
              <Button variant="danger" id="buttn-year">
                2020
              </Button>
            </Col>
            <Col sm={6} className="border">
              ...
              <p className="born">
                Tecygigwas born in the year 2020 The company has been
                kick-started by one great man – Harnil Oza with the exceptional
                passion & long vision.
              </p>
            </Col>
            ...
            <Col sm={6} className="border">
              ...
              <p className="born">
                The company was blooming from small to bigger star. In the
                initial years only, company worked with very well-known names of
                the industry.
              </p>
            </Col>
            <Col sm={6} className="border">
            ...
            <Col sm={6} className="border">
              ...
              <p className="born">
                Year by year the company was showing the sign to be superstar in
                the Mobile App Industry. Tecygig was gaining full trust of the
                clients. Company started work on many new projects, technologies
                which helped them to explore new horizons.
              </p>
            </Col>
            <Col sm={6} className="border">
              <Button variant="danger" id="buttn-year">
            ...
            <Col sm={6} className="border">
              ...
              <p className="born">
                Tecygig had become a brand now. The company set a benchmark and
                gained the trust of clients from all over the world. The company
                was getting bigger & better as far as size is concerned.
              </p>
            </Col>
          </Row>
        </Container>
