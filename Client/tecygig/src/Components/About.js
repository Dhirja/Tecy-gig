                ...
                <Container>
                    <Row className='year-container'>
                        ...
                        <Col sm={6} className='border' >
                            ...
                            <p className='born'>Tecygigwas born in the year 2011 The company has been kick-started by one
                        ...
                        <Col sm={6} className='border' >
                            ...
                            <p className='born'>Year by year the company was showing the sign to be superstar in the Mobile App Industry. Hyperlink Infosystem was gaining full trust of the clients. Company started work on many new projects, technologies which helped them to explore new horizons.
                            </p>
                        </Col>
                        <Col sm={6} className='border' >
                        ...
                        <Col sm={6} className='border' >
                            ...
                            <p className='born'>Hyperlink Infosystem had become a brand now. The company set a benchmark and gained the trust of clients from all over the world. The company was getting bigger & better as far as size is concerned.
                            </p>
                        </Col>
